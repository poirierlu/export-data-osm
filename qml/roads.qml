...
<qgis version="2.18.4" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="1" type="RuleRenderer" enableorderby="0">
    <rules key="{92f906fa-2c7d-4397-a73b-6f110ab807c4}">
      <rule filter=" &quot;highway&quot;  IN ( 'motorway') AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{f587f57c-5615-401e-b8e2-06304cc0e3a3}" symbol="0" label="motorway bridges"/>
      <rule filter=" &quot;highway&quot; IN ( 'motorway') " key="{0768ba5e-3993-4d3d-ab8d-13594dcb6d03}" symbol="1" label="motorway"/>
      <rule filter=" &quot;highway&quot; IN('trunk', 'motorway_link', 'trunk_link') AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{812dc440-3437-4fdf-9755-f21de3375feb}" symbol="2" label="trunk bridges"/>
      <rule filter=" &quot;highway&quot; IN('trunk', 'motorway_link', 'trunk_link')" key="{99c67a5b-f9e3-40ad-807b-baeaec245c9c}" symbol="3" label="trunk"/>
      <rule filter=" &quot;highway&quot; IN ('primary','primary_link')  AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{f3e36d83-6498-45b7-ac68-e5cf53603736}" symbol="4" label="primary bridges"/>
      <rule filter="&quot;highway&quot; IN ('primary','primary_link')" key="{1a1e6707-4cf3-48a3-8641-96c656b9a0e6}" symbol="5" label="primary "/>
      <rule filter="&quot;highway&quot; IN ('secondary','secondary_link') AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{37ca4857-168e-4fda-9714-22fbc2399a6c}" symbol="6" label="secondary bridges"/>
      <rule filter="&quot;highway&quot; IN ('secondary','secondary_link')" key="{2be82d0e-1f87-4442-a0a5-3c3caefa30ab}" symbol="7" label="secondary"/>
      <rule filter="&quot;highway&quot; IN ('tertiary', 'tertiary_link') AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{a57dc027-11e4-4878-8902-11a63c022344}" symbol="8" label="tertiary bridges"/>
      <rule filter="&quot;highway&quot; IN ('tertiary', 'tertiary_link')" key="{9cdc959a-63a1-49d2-8c36-17b6ae2296a0}" symbol="9" label="tertiary "/>
      <rule filter="&quot;highway&quot; IN ( 'road', 'living_street', 'residential', 'unclassified', 'pedestrian')  AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{cce01bea-bd55-43c4-adee-7dd3531dd4ec}" symbol="10" label="road bridges"/>
      <rule filter="&quot;highway&quot; IN ( 'road', 'living_street', 'residential', 'unclassified', 'pedestrian')" key="{ed06ef2e-c6ce-4f54-bacf-8ca06a43e68c}" symbol="11" label="road "/>
      <rule filter="&quot;highway&quot; IN ( 'service')  AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{65520920-30d9-4b15-965f-5c628d3d6724}" symbol="12" label="service roads bridges"/>
      <rule filter="&quot;highway&quot; IN ( 'service')" key="{0bde1619-a25e-426f-8127-a5dd2aa5ba1f}" symbol="13" label="service roads"/>
      <rule filter="&quot;highway&quot; = 'cycleway'  AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{d3b72b6a-5756-48ea-8f6e-3c0ef08ba817}" symbol="14" label="cycleway bridges"/>
      <rule filter="&quot;highway&quot; = 'cycleway'" key="{8999710b-f1b2-4154-b3a8-bd142b95fe3f}" symbol="15" label="cycleway"/>
      <rule filter="&quot;highway&quot; IN ('track') AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{527cd7f2-7fa4-4a60-82f2-0f33e29e186b}" symbol="16" label="track bridges"/>
      <rule filter="&quot;highway&quot; IN ('track')" key="{c3a311b4-4e35-4515-9f60-e0428a76004a}" symbol="17" label="track"/>
      <rule filter="&quot;highway&quot; IN ('path', 'footway') AND  &quot;bridge&quot; IN ('True', '1', 'yes')" key="{fd75a9ac-e70a-4e7a-84de-84072b9cc226}" symbol="18" label="path bridges"/>
      <rule filter="&quot;highway&quot; IN ('path', 'footway')" key="{039e54db-2b24-407c-ac22-aa62b4bdae27}" symbol="19" label="path"/>
    </rules>
    <symbols>
