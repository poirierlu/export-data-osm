...
<qgis version="2.18.4" simplifyAlgorithm="0" minimumScale="0" maximumScale="500100" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{47e6e71a-5bf3-45ce-8cd0-e85c76728c2b}">
      <rule filter="&quot;type&quot; = 'residential'" key="{301e2a0d-76d4-4862-af02-f5d549829b7b}" symbol="0" label="residential"/>
      <rule filter="&quot;type&quot;IN ('allotments', 'farm', 'farmland', 'farmyard')" key="{9307fb2e-1193-4134-a7ed-e014e3029daf}" symbol="1" label="allotments, farm, farmland, farmyard"/>
      <rule filter="&quot;type&quot; IN ( 'cemetery', 'grave_yard')" key="{816a0815-9e34-40af-9714-10dbf787c74c}" symbol="2" label="cemetery"/>
      <rule filter="&quot;type&quot; IN ('retail')" key="{8891d57d-e9fb-4ee1-8073-604c7d452098}" symbol="3" label="Retail"/>
      <rule filter="&quot;type&quot; IN ('industrial')" key="{c903b832-8f3b-4d00-b46a-8ae84f4eb3cf}" symbol="4" label="Industrial"/>
      <rule filter="&quot;type&quot; IN ('commercial')" key="{5458ce9b-d7fd-41e9-88db-9f747ab4bdf8}" symbol="5" label="Commercial"/>
      <rule filter="&quot;type&quot; = 'conservation'" key="{f25065bf-12eb-42e7-8488-5dbd4a6883e7}" symbol="6" label="conservation"/>
      <rule filter="&quot;type&quot; IN( 'grass', 'grassland', 'village_green', 'park')" key="{6c2525e2-0abf-4083-b361-0967b606c5a7}" symbol="7" label="grass, grassland, village green, park"/>
      <rule filter="&quot;type&quot; = 'greenhouse_horticulture'" key="{f02d1625-1cf6-4f42-83cb-414606cbe6bf}" symbol="8" label="greenhouse horticulture"/>
      <rule filter="&quot;type&quot; = 'meadow'" key="{9f0e3627-517d-4e63-b51e-b7d15df00475}" symbol="9" label="meadow"/>
      <rule filter="&quot;type&quot; = 'military'" key="{0e0cd68e-90f4-4e56-82ed-f6a703a8ebe8}" symbol="10" label="military"/>
      <rule filter="&quot;type&quot; = 'orchard'" key="{0ea6db1d-5cc4-49a9-9e49-cf483b3f75ce}" symbol="11" label="orchard"/>
      <rule filter="&quot;type&quot; = 'vineyard'" key="{96d8329a-a1d6-4885-ae06-8ce0e6b1baa7}" symbol="12" label="vineyard"/>
      <rule filter="&quot;type&quot; = 'quarry'" key="{68ec9da0-b4b8-47bb-ac62-e3fd305da03f}" symbol="13" label="quarry"/>
      <rule filter="&quot;type&quot; = 'landfill'" key="{d7b83c84-227c-4307-a3e3-53cc2b09f17b}" symbol="14" label="landfill"/>
      <rule filter="&quot;type&quot; = 'recreation_ground'" key="{565b6244-1bcf-4ae4-92db-36778eda2722}" symbol="15" label="recreation ground"/>
      <rule filter="&quot;type&quot; IN ('school', 'education')" key="{6a0b7797-13d3-4a7e-b4e0-eb262a90c97d}" symbol="16" label="school, education"/>
      <rule filter="&quot;type&quot; IN ('wood', 'forest')" key="{fb3f9752-c089-4592-9629-957694db66a2}" symbol="17" label="wood, forest"/>
      <rule filter="&quot;type&quot;IN ('aquaculture', 'basin', 'reservoir', 'pool')" key="{d653fd92-6356-4b16-824b-d7a469859575}" symbol="18" label="aquaculture, basin, reservoir, pool"/>
      <rule filter="&quot;type&quot; = 'salt_pond'" key="{ffd023dd-42f2-4c6d-964f-cae3a700eb44}" symbol="19" label="salt pond"/>
      <rule filter="&quot;type&quot; = 'harbour'" key="{8bd3151e-3b83-44f8-84ff-6354e9c8a2e1}" symbol="20" label="harbour"/>
      <rule filter="&quot;type&quot;  =  'pitch'" key="{1aca4f63-58ff-4d88-baa3-19170e619615}" symbol="21" label="pitch"/>
      <rule filter=" &quot;type&quot;  =  'farm' " key="{7d177b7d-1a8f-4097-b044-3aedffc069e2}" symbol="22" label="farm"/>
    </rules>
    <symbols>
